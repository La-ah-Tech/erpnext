...
from erpnext.laahtech_em_integrations.doctype.plaid_settings.plaid_connector import (
    PlaidConnector,
)
...
def get_transactions(bank, bank_account=None, start_date=None, end_date=None):
    ...
    if bank_account:
        ...
        access_token = frappe.db.get_value(
            "Bank", related_bank[0].bank, "plaid_access_token"
        )
    ...
    try:
        ...
        if e.code == "ITEM_LOGIN_REQUIRED":
            ...
            msg += (
                _("Please refresh or reset the Plaid linking of the Bank {}.").format(
                    bank
                )
                + " "
            )
            ...
            new_transaction = frappe.get_doc(
                {
                    ...
                    "transaction_type": (
                        ...
                        or transaction["payment_meta"]["payment_method"]
                    ),
                    "reference_number": (
...
def enqueue_synchronization():
    ...
    for plaid_account in plaid_accounts:
        frappe.enqueue(
            "erpnext.laahtech_em_integrations.doctype.plaid_settings.plaid_settings.sync_transactions",
